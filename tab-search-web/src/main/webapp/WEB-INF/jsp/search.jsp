            ...
            <div class="container">
                ...
                <div class="header-search">
                    <div class="header-search-child">
                        <input type="search" name="Search" placeholder=${query} required="" v-model="searchValue" @keyup.enter="search">
        ...
        <div class="container">
                ...
                <c:forEach items="${itemList}" var="item">
                    <div class="col-md-3 product-grids"> 
                        <div class="agile-products">
                            ...
                            <a href="http://qinteng.xin:8086/${item.id }.html"><img src="${item.images[0]}" class="img-responsive" alt="img"></a>
                            <div class="agile-product-text">              
                                <h5><a href="single.html">${item.title}</a></h5> 
                                <h6><del>￥${item.price / 50 }</del> ￥${item.price / 100 }</h6> 
                                <form action="#" method="post">
                                    <input type="hidden" name="cmd" value="_cart" />
                                    <input type="hidden" name="add" value="1" /> 
                                    <input type="hidden" name="w3ls_item" value="${item.id}" /> 
            ...
            <div class="col-md-3 rsidebar">
                <div class="rsidebar-top">
                    <div class="slider-left">
                        ...
                        <div class="row row1 scroll-pane">
                            ...
                            <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>￥200 - ￥500  </label> 
                            <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>￥500 - ￥1000  </label> 
                    ...
                    <div class="sidebar-row">
                        <h4>商店</h4>
                        <ul class="faq">
                            <li class="item1"><a href="#">服装<span class="glyphicon glyphicon-menu-down"></span></a>
                                <ul>
                                    <li class="subitem1"><a href="#">民族服装</a></li>                                       
                                    <li class="subitem1"><a href="#">孕妇装</a></li>                                        
                                    <li class="subitem1"><a href="#">运动装</a></li>                                       
                                </ul>
                            </li>
                            <li class="item2"><a href="#">饰品<span class="glyphicon glyphicon-menu-down"></span></a>
                                <ul>
                                    <li class="subitem1"><a href="#">手表</a></li>                                       
                                    <li class="subitem1"><a href="#">眼镜</a></li>                                                   
                                    <li class="subitem1"><a href="#">珠宝</a></li>                                     
                                    <li class="subitem1"><a href="#">鞋类</a></li>                                      
                                </ul>
                            </li>
                            <li class="item3"><a href="#">电子产品<span class="glyphicon glyphicon-menu-down"></span></a>
                                <ul>
                                    <li class="subitem1"><a href="#">手机</a></li>                                     
                    ...
                    <div class="sidebar-row">
                        <h4>折扣</h4>
                        <div class="row row1 scroll-pane">
                            <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>0% - 10% (20)</label>
                    ...
                    <div class="sidebar-row">
                        ...
                        <div class="row row1 scroll-pane">
                            ...
                            <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>粉红</label>
                            ...
                            <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>橘色</label>
                ...
                <div class="related-row">
                    <h4>相关搜索</h4>
                    <ul>
                        <li><a href="products.html">旅行袋</a></li>
                        <li><a href="products.html">休闲服装</a></li>
                        <li><a href="products.html">美的礼品蓝</a></li>
                        ...
                        <li><a href="products.html">洗护发用品</a></li>
                        <li><a href="products.html">手提包</a></li>
                    </ul>
                </div>
            </div>
            <div class="clearfix"> </div>
                    ...
                    <c:forEach items="${itemList}" var="item">
	                    <div class="item">
	                        <div class="glry-w3agile-grids agileits">
	                            ...
	                            <a href="products1.html"><img alt="img" src="${item.images[0]}"></a>
	                            <div class="view-caption agileits-w3layouts">           
	                                <h4><a href="products1.html">${item.id}</a></h4>
	                                <p>${item.title}</p>
        ...
        methods:{
            ...
            search:function(){
                if(search.searchValue.trim()){
                    window.open("http://qinteng.xin:8085/search?q="+search.searchValue);
                }
            },
            //获取cookie
            ...
            checkLogin:function(){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data.status == 200){
                        	search.isLogin = true;
                        	search.username = data.data.username;
            ...
            signout:function(){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data.status == 200){
                        	search.isLogin = false;
                        	search.username = "";
                        	search.delCookie("TT_TOKEN")
                        }
                    }
                });
            }
