...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="qinteng"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="1888888888"/>
...
<div class="step-tit">
	<h3>收货人信息</h3>
	<div class="extra-r">
		<a href="Javascript:void(0)" class="ftx-05">新增收货地址</a>
	</div>
</div>
<div class="step-cont">
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">qinteng</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">188****4566</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京市 海淀区</div>
						<div class="adr-m" limit="30">xxxxxxxxxxxxxxxxx</div>
...
<div class="step-tit">
	<h3>送货清单</h3>
	<div class="extra-r">
					<a href="http://qinteng.xin:8090/cart/cart.html" id="cartRetureUrl" class="return-edit ftx-05">返回修改购物车</a>
			</div>
</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：TAB商城</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">TAB快递<i
						class='qmark-icon qmark-tip'
						data-tips='由TAB公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由TAB配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
