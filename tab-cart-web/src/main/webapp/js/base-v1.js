 ...
 */
function login() {
    return location.href = "http://qinteng.xin:8088/page/login";
}
function regist() {
    return location.href = "http://qinteng.xin:8088/page/register";
}
...
function search(a) {
    var b = "http://qinteng,xin:8085/search?q=" + encodeURIComponent(document.getElementById(a).value);
